...
namespace prn_job_manager.Migrations
{
    ...
    [Migration("20230326113721_UpdateDatabase-637")]
    partial class UpdateDatabase637
    {
            ...
            modelBuilder.Entity("prn_job_manager.Models.Log", b =>
                {
                    ...
                    b.HasIndex(new[] { "JobId" }, "IX_Log_job_id");

                    b.HasIndex(new[] { "UserId" }, "IX_Log_user_id");
            ...
            modelBuilder.Entity("prn_job_manager.Models.QrtzBlobTrigger", b =>
                {
                    ...
                    b.HasIndex(new[] { "SchedName", "TriggerName", "TriggerGroup" }, "IX_QRTZ_BLOB_TRIGGERS_SCHED_NAME_TRIGGER_NAME_TRIGGER_GROUP");
            ...
            modelBuilder.Entity("prn_job_manager.Models.QrtzTrigger", b =>
                {
                    ...
                    b.HasIndex(new[] { "SchedName", "JobName", "JobGroup" }, "IX_QRTZ_TRIGGERS_SCHED_NAME_JOB_NAME_JOB_GROUP");
            ...
            modelBuilder.Entity("prn_job_manager.Models.UserJob", b =>
                {
                    ...
                    b.HasIndex(new[] { "JobId" }, "IX_User_Job_job_id");

                    b.HasIndex(new[] { "UserId" }, "IX_User_Job_user_id");
